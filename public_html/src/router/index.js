...
const routes = [
  ...
  // Admin (nested layout + full workflows)
  {
    ...
    children: [
      ...
      { path: 'manage-allocation', name: 'admin-manage-allocation', component: () => import('../views/admin/ManageAllocationView.vue') },
      { path: 'budget-allocation', redirect: '/admin/manage-allocation' },
      ...
      { path: 'data-privacy-policy', redirect: '/admin/user-manual?tab=privacy' },
  ...
  // College / TWG
  {
    ...
    children: [
      ...
      { path: 'data-privacy-policy', redirect: '/college/user-manual?tab=privacy' },
  ...
  // Staff
  {
    ...
    children: [
      ...
      { path: 'manage-allocation', name: 'staff-manage-allocation', component: () => import('../views/staff/ManageAllocationView.vue') },
      { path: 'budget-allocation', redirect: '/staff/manage-allocation' },
      ...
      { path: 'data-privacy-policy', redirect: '/staff/user-manual?tab=privacy' },
