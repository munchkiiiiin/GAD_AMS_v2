    ...
    <div style="margin: 32px 32px 0 32px; border-radius: 16px; border: 1px solid var(--border); overflow: hidden; box-shadow: 0 10px 25px -5px rgba(0,0,0,0.3); background: var(--surface); display: flex; flex-direction: column;">
      ...
      <header class="topbar">
        ...
        <div class="topbar-actions">
          <router-link to="/admin/manage-allocation" class="topbar-btn secondary" style="background: rgba(59, 130, 246, 0.2); border: 1px solid rgba(59, 130, 246, 0.4); color: #93c5fd; text-decoration: none; display: inline-flex; align-items: center; gap: 4px;">
            <span>💳</span> Manage Allocation
          </router-link>
